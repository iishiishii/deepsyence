...
import { addChannel, filterChannels, stackSliceToRGB } from "./channelHandlers";
import { arrayToMat } from "./imageConversion";
import { downloadImage } from "./imageConversion";
...
function interpolateSlices(slice1, slice2, alpha) {
